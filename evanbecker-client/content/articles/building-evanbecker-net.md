...
description: "It all started a few months ago when I noticed that I wasn't getting emails. I thought that was rather strange, as I hosted my email service through Zoho, and had no history of problems using my domain for years."
date: '2023-11-06'
tags:
  - software
---
...
![Auth0 API Configuration](/images/articles/building-evanbecker-net/auth0-api-api.png)

![Auth0 API Settings](/images/articles/building-evanbecker-net/auth0-api.png)

![Auth0 SPA Settings](/images/articles/building-evanbecker-net/auth0-spa.png)
...
For more details on this project or my other active endeavors, visit the [Articles](/articles) section on this site.
