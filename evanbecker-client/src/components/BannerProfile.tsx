...
import meImage from '@/images/custom/evan-becker.png'
const social = [
  {
    name: 'Facebook',
    href: '#',
...
const profile: any = {
  ...
  avatar: meImage,
  backgroundImage:
    'https://images.unsplash.com/photo-1486393418071-83cd9b65f9e8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2125&q=80',
  fields: [
    ['Phone', '(555) 123-4567'],
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-end sm:space-x-5">
          <div className="flex pl-4 pt-6">
            <Image
                className="h-16 w-16 rounded-xl sm:h-48 sm:w-48"
                src={meImage}
                alt=""
            />
          </div>
          <div className="sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
            <div className="min-w-0 flex-1 pl-2 pb-8 sm:hidden md:block">
              <h1 className="truncate text-3xl font-bold">Evan Becker 🤓</h1>
              <h1 className="truncate text-xl ">Technical Architect @nvisia</h1>
            </div>
