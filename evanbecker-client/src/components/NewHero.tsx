...
export function NewHero() {
  return (
    <div className="bg-slate-900 dark:mt-[-4.75rem] dark:-mb-32 dark:pt-[4.75rem] dark:pb-32">
      <div className="py-16 sm:px-2 lg:relative lg:px-0 lg:py-20">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-[96rem] lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-xl tracking-tight text-slate-300">
                Welcome to the new{' '}
                <SimpleLink href="#">evanbecker.net</SimpleLink>.
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-300">
                This UI is built using{' '}
                <SimpleLink href="https://tailwindcss.com/">
                  Tailwind CSS
                </SimpleLink>{' '}
                and <SimpleLink href="https://nextjs.org/">Next.js</SimpleLink>,
                the backend in{' '}
                <SimpleLink href="https://dotnet.microsoft.com/en-us/download/dotnet/10.0">
                  .NET 10
                </SimpleLink>{' '}
                w/{' '}
                <SimpleLink href="https://learn.microsoft.com/en-us/ef/">
                  Entity Framework
                </SimpleLink>
                , database using{' '}
                <SimpleLink href="https://www.postgresql.org/">
                  PostgreSQL
                </SimpleLink>
                ,{' '}
                <SimpleLink href="https://traefik.io/traefik/">
                  Traefik
                </SimpleLink>{' '}
                as a reverse proxy,{' '}
                <SimpleLink href="https://en.wikipedia.org/wiki/CI/CD">
                  CI/CD
                </SimpleLink>{' '}
                using{' '}
                <SimpleLink href="https://github.com/features/actions">
                  GitHub Actions
                </SimpleLink>
                , containerized using{' '}
                <SimpleLink href="https://www.docker.com/">Docker</SimpleLink>,
                and autonomous deployment to a{' '}
                <SimpleLink href="https://m.do.co/c/bb04ad8bf1c5">
                  DigitalOcean Droplet
                </SimpleLink>
                .
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/articles/building-evanbecker-net">
                  So, how&apos;d you do it?
                </Button>
