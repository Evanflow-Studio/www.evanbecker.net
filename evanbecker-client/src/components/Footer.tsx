...
import {GitLabIcon} from "@/components/SocialIcons";
  ...
  social: [
    {
      ...
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
          <svg fill="currentcolor" viewBox="50 50 280 280" aria-hidden="true" {...props}>
    ...
    },
    {
      ...
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
               width="22" height="22" viewBox="0 0 192 192">
            {
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/channel/UCM8OJunXu8faJTkGZo4iDTw',
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    <footer>
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-400">
          &copy; 2023 Evan Becker™. All rights reserved.
        </p>
      </div>
    </footer>
  )
