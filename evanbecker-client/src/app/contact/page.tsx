        ...
        <>
            ...
            <div className="isolate px-6 py-24 sm:py-32 lg:px-8">
                <div className="mx-auto max-w-2xl sm:text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-200 sm:text-4xl">Other Contact Methods</h2>
                    <p className="mt-2 text-lg leading-8 text-gray-400">
                        These are less reliable, but I&apos;ll still see them <div className="inline-flex text-xs">(eventually 👀)</div>.
                    </p>
                </div>
