...
Auth0 implementation, especially concerning client-sided login systems. At present, the Recat, client-only approach, seemed sufficient for the project's needs.
