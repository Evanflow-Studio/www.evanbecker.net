...
NUXT_PUBLIC_SITE_URL=${PROD_SITE_URL}
NUXT_PUBLIC_API_URL=${PROD_API_URL}
NUXT_PUBLIC_AUTH0_DOMAIN=${PROD_AUTH0_DOMAIN}
NUXT_PUBLIC_AUTH0_CLIENT_ID=${PROD_AUTH0_CLIENT_ID}
NUXT_PUBLIC_AUTH0_AUDIENCE=${PROD_AUTH0_AUDIENCE}
NUXT_PUBLIC_AUTH0_REDIRECT_URI=${PROD_AUTH0_REDIRECT_URI}
EOF"
...
NUXT_PUBLIC_SITE_URL=${TEST_SITE_URL}
NUXT_PUBLIC_API_URL=${TEST_API_URL}
NUXT_PUBLIC_AUTH0_DOMAIN=${TEST_AUTH0_DOMAIN}
NUXT_PUBLIC_AUTH0_CLIENT_ID=${TEST_AUTH0_CLIENT_ID}
NUXT_PUBLIC_AUTH0_AUDIENCE=${TEST_AUTH0_AUDIENCE}
NUXT_PUBLIC_AUTH0_REDIRECT_URI=${TEST_AUTH0_REDIRECT_URI}
EOF"
