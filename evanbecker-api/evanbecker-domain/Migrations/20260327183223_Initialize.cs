    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Auth0Id = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ...
                    SpotifyTokenExpiry = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    SpotifyPremium = table.Column<bool>(type: "boolean", nullable: false),
                    SpotifyDisplayName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentText = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    TargetLocation = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
